...
public class OI {
	...
	public OI()
	{
		...
		JoystickButton clamp = new JoystickButton(driveJoystick, 11);
		JoystickButton reverseClamp = new JoystickButton(driveJoystick, 12);
		//JoystickButton elevatorUp = new JoystickButton(driveJoystick, 10);
		//JoystickButton elevatorDown = new JoystickButton(driveJoystick, 9);
